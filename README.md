...
For example, if the user provides the name "mywebsite", the new cofiguration file will be named "mywebsite.conf" and its settings will be:
	ServerAdmin webmaster@mywebsite.com
	DocumentRoot /var/www/mywebsite
	ServerName mywebsite.com

Of course, the script can be easily edited if you wish to change the settings template; just make the necessary adjustments to the sed command and you're good to go ;-)
